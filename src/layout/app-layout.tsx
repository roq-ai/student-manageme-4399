...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['teacher', 'school-administrator', 'parent', 'student'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Courses', path: '/courses', entity: 'course', service: AccessServiceEnum.PROJECT, icon: FiBox },
    { name: 'Parents', path: '/parents', entity: 'parent', service: AccessServiceEnum.PROJECT, icon: FiUsers },
